  ...
  <div class="menu">
    ...
    <div class="nav">
      <div class="nav__content">
        <ul class="nav__list">
          <li class="nav__list-item active-nav"><a
              href="#"
              class="hover-target"
            >home</a></li>
          <li class="nav__list-item"><a
              href="#"
              class="hover-target"
            >studio</a></li>
          <li class="nav__list-item"><a
...
export default {
  ...
  mounted () {
    ...
    document.querySelector(".menu").addEventListener("mousemove", function (n) {
    ...
    document.querySelector("#switch").addEventListener('click', function () {
      if (Array.from(document.querySelector(".menu").classList).includes("light")) {
